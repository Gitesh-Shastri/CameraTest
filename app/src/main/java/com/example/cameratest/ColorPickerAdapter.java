...
public class ColorPickerAdapter extends RecyclerView.Adapter<ColorPickerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Drawable color = new ColorDrawable((colorPickerColors.get(position)));
        Drawable image = context.getResources().getDrawable(R.drawable.layout_bg);
        LayerDrawable ld = new LayerDrawable(new Drawable[]{color, image});
        holder.colorPickerView.setImageDrawable(ld);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            colorPickerView.setBackgroundResource(R.drawable.layout_bg);
