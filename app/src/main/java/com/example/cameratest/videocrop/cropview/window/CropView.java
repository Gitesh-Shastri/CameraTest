package com.example.cameratest.videocrop.cropview.window;
...
import com.example.cameratest.videocrop.cropview.util.AspectRatioUtil;
import com.example.cameratest.videocrop.cropview.util.HandleUtil;
import com.example.cameratest.videocrop.cropview.util.PaintUtil;
import com.example.cameratest.videocrop.cropview.window.edge.Edge;
import com.example.cameratest.videocrop.cropview.window.handle.Handle;
...
public class CropView extends View {
    ...
    public void registerCall(Callable<Void> call) {
        callable = call;
    }
}
